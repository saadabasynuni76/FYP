...
GOOGLE_FACT_KEY = get_secret("GOOGLE_FACT_KEY")

MODEL_A = "google/gemma-3-27b-it:free"
MODEL_B = "google/gemma-3-12b-it:free"

# Check if keys are missing to warn the user
if not all([MONGODB_URI, OPENROUTER_API_KEY, SERPER_API_KEY, GOOGLE_FACT_KEY]):
    st.error("Missing API Keys! Please set them in your environment variables or Streamlit secrets.")
